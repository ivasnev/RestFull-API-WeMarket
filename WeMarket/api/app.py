...
from WeMarket.api.handlers import HANDLERS
from WeMarket.api.middleware import error_middleware, handle_validation_error
from WeMarket.api.payloads import AsyncGenJSONListPayload, JsonPayload
from WeMarket.utils.pg import setup_pg
...
def create_app(args: Namespace) -> Application:
    ...
    setup_aiohttp_apispec(app=app, title='WeMarket API', swagger_path='/',
